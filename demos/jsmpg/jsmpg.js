(function(window) {
    ...
    jsmpeg.prototype.load = function(url) {
        this.url = url;
        var that = this;
        if (this.progressive && window.fetch && window.ReadableByteStream) {
    ...
    var SOCKET_MAGIC_BYTES = 'jsmp',
        ...
        SHADER_FRAGMENT_LOADING = ['precision mediump float;', 'uniform float loaded;', 'varying vec2 texCoord;', 'void main() {', 'float c = ceil(loaded-(1.0-texCoord.y));',
